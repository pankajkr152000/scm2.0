...
public class OAuthSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private final Users userToStore = new Users();
    ...
    public OAuthSuccessHandler(UserSignupFormServicesImpl userSignupFormServicesImpl) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        boolean isUserEmailPresent = userSignupFormServicesImpl.isUserExistsByEmail(userToStore.getEmail());
        if(!isUserEmailPresent) {
            userSignupFormServicesImpl.saveUser(userToStore);
            log.info("User saved : {}", userToStore.getEmail());
        } 
